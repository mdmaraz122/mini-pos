<div class="modal fade" id="createBrand"  role="dialog" aria-labelledby="formModal" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="formModal">Create Brand</h5>
                ...
                <form id="BrandCreateForm">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" oninput="textToSlug()" placeholder="Brand Name" id="name">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" disabled placeholder="Brand Slug" id="slug">
                        </div>
                    </div>
                    <button type="button" class="btn btn-primary m-t-15 w-100 waves-effect" onclick="createBrand()">Create</button>
    ...
    async function createBrand() {
        try {
            if(!document.getElementById('name').value){
                ...
                let res = await axios.post('/backendData/brand-create', formData, {
                    headers: {
                ...
                if (res.data['status'] === 'success') {
                    ...
                    document.getElementById('BrandCreateForm').reset();
