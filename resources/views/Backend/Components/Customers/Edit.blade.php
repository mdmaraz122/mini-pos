<div class="modal fade" id="EditCustomer"  role="dialog" aria-labelledby="formModal" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="formModal">Edit Customers</h5>
                ...
                <form id="CustomerEditForm">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" placeholder="Customer Name" id="edit_name">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" class="form-control" placeholder="Customer Phone" id="edit_phone">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" placeholder="Customer Address" id="edit_address">
                        </div>
                    </div>
                    <div class="form-group">
...
<script>
    async function GetEditCustomerData(id){
        let res = await axios.post('/backendData/customers-single/', {id: id});
        document.getElementById('edit_name').value = res.data['data']['name'];
        document.getElementById('edit_phone').value = res.data['data']['phone'];
        document.getElementById('edit_address').value = res.data['data']['address'];
        document.getElementById('edit_status').value = res.data['data']['status'];
        document.getElementById('edit_customer_id').value = res.data['data']['id'];
    }
    ...
    async function updateBaseUnit() {
        try {
            ...
            formData.append('id', document.getElementById('edit_customer_id').value);

            let res = await axios.post('/backendData/customers-update', formData);
